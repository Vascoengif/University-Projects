...
//    $("#procurarEventoForm").on("submit", function(){
//        $("#eventosADecorrer").hide();
...
//    });
    ...
    $("#login_form").on("submit", function(event){
        ...
        var formValues = $(this).serialize();
        //var actionUrl = "http://localhost:8080/algoqueaindanaoseibemaqui"; é o @PostMapping no servidor
...
//            }
//            else{
//                window.open("/...../...../..../MainPage_Athlete.html");
//            }
//        });
    });
