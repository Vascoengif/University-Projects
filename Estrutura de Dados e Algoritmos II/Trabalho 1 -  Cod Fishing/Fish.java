...
public class Fish
{
    ...
    public static long returnDistanceBetween_B_and_S(int [][] arrayBoats, int [][] arraySpots, int positionBoat, int positionSpot)
    {
    ...
    public static long[] solve(int numberOfFishingBoats, int numberOfFishingSpots, int [][]arrayOfBoats, int [][] arrayOfSpots)
    {
        long[] solution = new long[3];          //array to return the solution values

        long sumRating, sumSpots, sumDistance;      
        ...
        {
            long distanceTravelled[][] = new long [numberOfFishingBoats+1][numberOfFishingSpots+1];       //we create to matrices to. 1 - calculate the minimal value of distance
            long amountOfRating[][] = new long [numberOfFishingBoats+1][numberOfFishingSpots+1];          //travelled by all the picked boats; AND 2 - calculate the minimal value of
            ...
            for(int l = numberOfFishingBoats-1; l >= 0; l--)
            {
                ...
                {
                    long auxDistance = distanceTravelled[l+1][c+1] + returnDistanceBetween_B_and_S(arrayOfBoats, arrayOfSpots, l, c);
                    long auxRating = amountOfRating[l+1][c+1] + arrayOfBoats[l][2];
